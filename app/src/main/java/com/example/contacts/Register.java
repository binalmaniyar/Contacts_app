    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    if(etPassword.getText().toString().equals(etReEnter.getText().toString().trim()))
                    {
                    ...
                    {
                        Toast.makeText(Register.this, "Make sure that your password ans re-enter password matches !!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
